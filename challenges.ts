...
*/
// type addTwoFunction = (n: number) => number;

// const map = (numbers: number[], callback: addTwoFunction): number[] => {
...
*/
// type callBackFunction = (char: string) => void;
// const forEach = (arr: string[], callback: callBackFunction) => {
...
// function forEach(arr: number[], callback: (value: number) => void) {
//   for (const value of arr) {
//     callback(value);
//   }
// }
// const mapWith = (arr: number[], callback: (value: number) => number): number[] => {
//   const newArray: number[] = [];
//   forEach(arr, (value) => {
...
// function reduce(arr: number[], callback: callBackFunction, initialValue: number): number {
 ...
 */
// function intersection(arr1: number[], arr2: number[], arr3: number[]): number[] {
//   const arrays: number[][] = [arr1, arr2, arr3];
...
//   const arrays: number[][] = [arr1, arr2, arr3];
//   return arrays.reduce((acc: number[], curr: number[]) => {
//     curr.forEach(value => {
...
// const objOfMatches = (arr1: string[], arr2: string[], callBack: callBackFunction) => {
//   return arr1.reduce<Record<string, string>>((acc, curr, index) => {
//     if (callBack(curr) === arr2[index]) {
//       acc[curr] = arr2[index];
//     }
//     return acc;
//   }, {});
...
*/
// type callBackFunction = (str: string) => string;
// interface MultiMapObject {
//   [key: string]: string[];
// }

// const multiMap = (values: string[], callBacks: callBackFunction[]) => {
//   const result: MultiMapObject = {};
...
//   [key: string]: string;
// }
// const objectFilter = (obj: City, callback: callBackFunction): City => {
//   const result: City = {};
...
// const majority = (arr: number[], callBack: callBackFunction) => {
//   let trueSum: number = 0;
//   let falseSum: number = 0;
  
//   arr.forEach(num => {
//     callBack(num) ? trueSum++ : falseSum++
//   })
...
// type callBackFunction = (str: string) => boolean;
// const prioritize = (arr: string[], callBack: callBackFunction) => {
//   const trueItems: string[] = [];
...
*/
// type callBackFunction = (num: number) => string;
// interface CountObject{
//   [key: string]: number;
// }
// const countBy = (arr: number[], callBack: callBackFunction) => {
...
// const groupBy = (arr: number[], callBack: callBackFunction) => {
...
// const goodKeys = (obj: Character, callBack: callBackFunction) => {
//   const result: string[] = [];
...
// const commutative = (callBack1: callBackFunction, callBack2: callBackFunction, num: number) => {
//   const firstOrder = callBack2(callBack1(num));
//   const secondOrder = callBack1(callBack2(num));
...
// }
// type callBackFunction = (n: number) => number;
// const objFilter = (obj: numObj, callBack: callBackFunction) => {
//     const newObj: numObj = {};
//     for(const key in obj){
//         const value = obj[key];
//         if(callBack(parseInt(key)) == value){
//             newObj[key] = value;
//         }
//     }
//     return newObj;
// }
// const startingObj: numObj = {};
// startingObj[6] = 3;
// startingObj[2] = 1;
// startingObj[12] = 4;
...
*/
// type func = (n: number) => boolean;

// const rating = (arr: func[], num: number) => {
//     const passed = arr.filter(fn => fn(num)).length;
...
*/
// type callBackFunction = (str: string) => string;
// const pipe = (arr: callBackFunction[], value: string) => {
//     return arr.reduce((acc, fn) => fn(acc), value);
// }
...
// const highestFunc = (funk: Funk, num: number) => {
//     let highestKey = "";
//     let highestValue = -Infinity;

//     for (const key in funk) {
//     const result = funk[key]!(num);
...
// const combineOperations = (value: number, arr: callBackFunction[]) => {
//     return arr.reduce((acc, fn) => fn(acc), value);
// }
...
*/
// type isOddAgainFunction = (num: number) => boolean;

// const myFunc = (arr: number[], callBack: isOddAgainFunction) => {
//     for (let i = 0; i < arr.length; i++) {
//         if (callBack(arr[i]!)) {
//         return i;
//         }
...
// const numbers: number[] = [2, 3, 6, 64, 10, 8, 12];
// const evens: number[] = [2, 4, 6, 8, 10, 12, 64];

// function isOddAgain(num: number) {
//   return num % 2 !== 0;
// }
 ...
 */
// type addToSumFunction = (num: number) => void;
// const myForEach = (arr: number[], callBack: addToSumFunction) => {
//     for (let i = 0; i < arr.length; i++) {
//         callBack(arr[i]!);
//     }
// }
